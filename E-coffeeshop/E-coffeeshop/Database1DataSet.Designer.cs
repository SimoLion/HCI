...
namespace E_coffeeshop {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public BooksRow AddBooksRow(string Title, string Author, decimal Price) {
...
namespace E_coffeeshop.Database1DataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Books` WHERE ((`ID` = ?) AND ((? = 1 AND `Title` IS NULL) OR (`Title" +
                "` = ?)) AND ((? = 1 AND `Author` IS NULL) OR (`Author` = ?)) AND ((? = 1 AND `Pr" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Books` (`Title`, `Author`, `Price`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Books` SET `Title` = ?, `Author` = ?, `Price` = ? WHERE ((`ID` = ?) AND (" +
                "(? = 1 AND `Title` IS NULL) OR (`Title` = ?)) AND ((? = 1 AND `Author` IS NULL) " +
                "OR (`Author` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::E_coffeeshop.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Title, Author, Price FROM Books";
        ...
        public virtual int Delete(int Original_ID, string Original_Title, string Original_Author, global::System.Nullable<decimal> Original_Price) {
        ...
        public virtual int Insert(string Title, string Author, global::System.Nullable<decimal> Price) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, string Author, global::System.Nullable<decimal> Price, int Original_ID, string Original_Title, string Original_Author, global::System.Nullable<decimal> Original_Price) {
            if ((Title == null)) {
